...
namespace MVC.Controllers
{
    public class RestaurantesController : Controller
    {
        ...
        {
            var restaurantes = db.Restaurantes.Include(r => r.Imegenes).Include(r => r.User);
        ...
        public async Task<ActionResult> Create([Bind(Include = "nit,nombre,direccion,slogan,puntuacion,tenedor,fecha,user_cedula")] Restaurantes restaurantes)
        {
